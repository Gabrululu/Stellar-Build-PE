...
var n = function(t3, s, r2, e) {
  ...
  for (var h = 1; h < s.length; h++) {
    var p = s[h++], a2 = s[h] ? (s[0] |= p ? 1 : 2, r2[s[h++]]) : s[++h];
    3 === p ? e[0] = a2 : 4 === p ? e[1] = Object.assign(e[1] || {}, a2) : 5 === p ? (e[1] = e[1] || {})[s[++h]] = a2 : 6 === p ? e[1][s[++h]] += a2 + "" : p ? (u = t3.apply(a2, n(t3, a2, r2, ["", null])), e.push(u), a2[0] ? s[0] |= 2 : (s[h - 2] = 0, s[h] = u)) : e.push(a2);
  }
  return e;
};
...
function htm_module_default(s) {
  ...
  return r2 || (r2 = /* @__PURE__ */ new Map(), t.set(this, r2)), (r2 = n(this, r2.get(s) || (r2.set(s, r2 = function(n2) {
    for (var t3, s2, r3 = 1, e = "", u = "", h = [0], p = function(n3) {
      ...
      a2 && (1 === r3 && p(), p(a2));
      for (var l = 0; l < n2[a2].length; l++) t3 = n2[a2][l], 1 === r3 ? "<" === t3 ? (p(), h = [h], r3 = 3) : e += t3 : 4 === r3 ? "--" === e && ">" === t3 ? (r3 = 1, e = "") : e = t3 + e[0] : u ? t3 === u ? u = "" : e += t3 : '"' === t3 || "'" === t3 ? u = t3 : ">" === t3 ? (p(), r3 = 1) : r3 && ("=" === t3 ? (r3 = 5, s2 = e, e = "") : "/" === t3 && (r3 < 5 || ">" === n2[a2][l + 1]) ? (p(), 3 === r3 && (h = h[0]), r3 = h, (h = h[0]).push(2, 0, r3), r3 = 0) : " " === t3 || "	" === t3 || "\n" === t3 || "\r" === t3 ? (p(), r3 = 2) : e += t3), 3 === r3 && "!--" === e && (r3 = 4, h = h[0]);
    }
    return p(), h;
...
// node_modules/@creit.tech/stellar-wallets-kit/node_modules/@twind/core/core.dev.js
var active;
...
function defineConfig({ presets = [], ...userConfig }) {
  ...
  for (let preset of asArray([
    ...
    let { preflight: preflight2, darkMode = config2.darkMode, darkColor = config2.darkColor, theme: theme3, variants: variants2, rules: rules2, ignorelist, hash: hash2 = config2.hash, stringify = config2.stringify, finalize } = "function" == typeof preset ? preset(config2) : preset;
    config2 = {
      ...
      theme: {
        ...
        extend: {
          ...
          ...theme3 == null ? void 0 : theme3.extend
        }
      },
      variants: [
        ...config2.variants,
...
function twind(userConfig, sheet) {
  let config2 = defineConfig(userConfig), context = function({ theme: theme3, darkMode, darkColor = noop, variants: variants2, rules: rules2, hash: hash$1, stringify, ignorelist, finalize }) {
  ...
  return Object.defineProperties(function tw3(tokens) {
    if (!cache2.size) for (let preflight2 of asArray(config2.preflight)) {
    ...
    if (!className) {
      ...
      for (let rule18 of translate(parse(tokens), context)) classNames.add(rule18.c).add(insert(rule18));
      className = [
        ...classNames
      ].filter(Boolean).join(" ");
...
function virtual(includeResumeData) {
  ...
  return {
    ...
    insert(css2, index, rule18) {
      target.splice(index, 0, includeResumeData ? `/*!${rule18.p.toString(36)},${(2 * rule18.o).toString(36)}${rule18.n ? "," + rule18.n : ""}*/${css2}` : css2);
    },
    resume: noop
  };
}
...
function presetAutoprefix() {
  return ({ stringify }) => ({
    stringify(property, value, context) {
      ...
      let propertyFlags = a(property), valueFlags = t2(property, value);
...
var theme2 = {
  ...
  boxShadowColor: alias2("colors"),
  // container: {},
  // cursor: {
  //   // Default values are handled by plugin
  // },
  caretColor: alias2("colors"),
  ...
  scrollMargin: alias2("spacing"),
  scrollPadding: alias2("spacing"),
  sepia: {
    0: "0",
    DEFAULT: "100%"
  },
  ...
  textDecorationColor: alias2("colors"),
...
function alias2(section) {
  return ({ theme: theme3 }) => theme3(section);
}

// node_modules/@creit.tech/stellar-wallets-kit/node_modules/@twind/preset-tailwind/preflight.dev.js
var preflight = {
  /*
...
// node_modules/@creit.tech/stellar-wallets-kit/node_modules/@twind/preset-tailwind/rules.dev.js
var rule;
var rule1;
var rule2;
var rule3;
...
var rules = [
  ...
  match("container", (_, { theme: theme3 }) => {
    let { screens = theme3("screens"), center, padding } = theme3("container"), rules2 = {
      width: "100%",
  ...
  matchTheme("animate(?:$|-)", "animation", (match2, { theme: theme3, h, e }) => {
    let animation3 = join(match2), parts = animation3.split(" "), keyframeValues = theme3("keyframes", parts[0]);
...
// node_modules/@creit.tech/stellar-wallets-kit/node_modules/@twind/preset-tailwind/variants.dev.js
var variants = [
  [
    "sticky",
  ...
  [
    ...
    `${$$}="true"`}]`, ({ 1: $1 }, { theme: theme3 }) => [
      .../* @__PURE__ */ new Set([
        ...
        ...Object.keys(theme3($1) || {})
      ])
    ].map((key) => ({
      suffix: key,
      label: `&[${$1}-${theme3($1, key) || `${key}="true"`}]`,
      theme: {
        section: $1,
        key
      }
  ...
  [
    ...
    }, (_, { theme: theme3 }) => Object.keys(theme3("supports") || {}).map((key) => ({
      suffix: key,
      theme: {
        section: "supports",
        key
  ...
  [
    ...
    }, (_, { theme: theme3 }) => Object.entries(theme3("screens") || {}).filter(([, value]) => "string" == typeof value).map(([key, value]) => ({
      suffix: key,
...
// node_modules/@creit.tech/stellar-wallets-kit/node_modules/@twind/preset-tailwind/base.dev.js
  ...
  return {
    ...
    finalize(rule18) {
      return (
        ...
        rule18.r.some((r2) => /^&::(before|after)$/.test(r2)) && // there is no content property yet
...
function Button({ size = ButtonSize.md, mode: mode2 = ButtonMode.primary, shape = ButtonShape.regular, classes, styles, children, onClick }) {
  ...
  const theme3 = mode2 === ButtonMode.free ? "" : tw2(cx("cursor-pointer", defaultClasses, modeStyle, radius, sizeStyle, padding));
  return m`
...
function PageTransition({ children, isActive, duration = 300 }) {
  ...
  return m`<div style=${styles}>${children}</div>`;
}
function MultiPageAnimator({ currentRoute, pages: pages2, duration = 300 }) {
  const entries = Object.entries(pages2).map(([key, Component]) => m`
      <${PageTransition} id=${key} key=${key} isActive=${currentRoute === key} duration=${duration}>
        <${Component} />
      <//>
    `);
  return m`<div style=${{ position: "relative", width: "100%", height: "100%" }}>${entries}</div>`;
}
...
var sortedWallet = g(() => {
  ...
  let usedWalletsIds;
  try {
    const record = globalThis == null ? void 0 : globalThis.localStorage.getItem(LocalStorageKeys.usedWalletsIds);
  ...
  return [
    ...usedWallets.sort((a2, b) => {
      return usedWalletsIds.indexOf(a2.id) - usedWalletsIds.indexOf(b.id);
    }),
    ...nonUsedWallets,
  ...
  return m`
    <section class="${tw2("w-full flex flex-col pb-8")}">
      <div class="${tw2("w-full flex justify-center mb-4")}">
        <${Avatar} alt="${(_a = activeModule.value) == null ? void 0 : _a.productName} icon" image="${(_b = activeModule.value) == null ? void 0 : _b.productIcon}" size="${AvatarSize.xl}" />
      </div>
...
var StellarWalletsKit = class _StellarWalletsKit {
  ...
  static signTransaction(xdr, opts) {
    return _StellarWalletsKit.selectedModule.signTransaction(xdr, {
      ...opts,
      networkPassphrase: (opts == null ? void 0 : opts.networkPassphrase) || selectedNetwork.value
    });
  }
  ...
  static async refreshSupportedWallets() {
    const results = await Promise.all(activeModules.value.map(async (mod) => {
      const timer = new Promise((r2) => setTimeout(() => r2(false), 1e3));
      return {
        id: mod.productId,
  ...
  static async authModal(params) {
    ...
    mode.value = (params == null ? void 0 : params.container) ? SwkAppMode.BLOCK : SwkAppMode.FIXED;
    const wrapper = document.createElement("div");
    ((params == null ? void 0 : params.container) || document.body).appendChild(wrapper);
    R(m`
        <${SwkApp} />
      `, wrapper);
    ...
    const close = () => {
      ...
      for (const sub of subs)
        sub();
      R(null, wrapper);
      (_a = wrapper.parentNode) == null ? void 0 : _a.removeChild(wrapper);
    };
