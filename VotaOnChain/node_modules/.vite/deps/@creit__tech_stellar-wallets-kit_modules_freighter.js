      ...
      const n = (r2) => {
        ...
        if (U) {
          ...
          const o2 = await (async (r3, s3, t3) => {
            ...
            const T2 = (t3 || {}).address;
            try {
              o3 = await n({ blob: r3, accountToSign: T2, apiVersion: "6.0.0", networkPassphrase: null == t3 ? void 0 : t3.networkPassphrase, type: e.SUBMIT_BLOB });
            } catch (r4) {
        ...
        if (U) {
          ...
          const o2 = await (async (r3, s3, t3) => {
            ...
            let T2;
            try {
              T2 = await n({ entryXdr: r3, accountToSign: o3, apiVersion: "6.0.0", networkPassphrase: null == t3 ? void 0 : t3.networkPassphrase, type: e.SUBMIT_AUTH_ENTRY });
            } catch (r4) {
...
var FreighterModule = class {
  ...
  async isAvailable() {
    var _a, _b;
    if (((_a = window.stellar) == null ? void 0 : _a.provider) === "freighter" && ((_b = window.stellar) == null ? void 0 : _b.platform) === "mobile")
      return false;
    try {
  ...
  async getAddress(params) {
    try {
      ...
      if ((params == null ? void 0 : params.skipRequestAccess) !== true) {
  ...
  async signTransaction(xdr, opts) {
    try {
      ...
      const { signedTxXdr, signerAddress, error } = await (0, import_freighter_api.signTransaction)(xdr, {
        ...
        networkPassphrase: opts == null ? void 0 : opts.networkPassphrase
      });
      if (error)
        return Promise.reject(error);
...
//# sourceMappingURL=@creit__tech_stellar-wallets-kit_modules_freighter.js.map
