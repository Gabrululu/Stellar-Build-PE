...
function L(n3, l5, u4, t4, i4, r4, o4, e4, f4, c4, s4) {
  ...
  for (f4 = T(u4, l5, m4, f4, b4), a4 = 0; a4 < b4; a4++) null != (p5 = u4.__k[a4]) && (h5 = -1 != p5.__i && m4[p5.__i] || d, p5.__i = a4, _4 = q(n3, p5, h5, i4, r4, o4, e4, f4, c4, s4), v4 = p5.__e, p5.ref && h5.ref != p5.ref && (h5.ref && J(h5.ref, null, p5), s4.push(p5.ref, p5.__c || v4, p5)), null == y5 && null != v4 && (y5 = v4), (g4 = !!(4 & p5.__u)) || h5.__k === p5.__k ? (f4 = j(p5, f4, n3, g4), g4 && h5.__e && (h5.__e = null)) : "function" == typeof p5.type && void 0 !== _4 ? f4 = _4 : v4 && (f4 = v4.nextSibling), p5.__u &= -7);
  return u4.__e = y5, f4;
}
...
function q(n3, u4, t4, i4, r4, o4, e4, f4, c4, s4) {
  var a4, h5, p5, v4, y5, d5, _4, k3, x4, M, $2, I2, P2, A3, H2, T4 = u4.type;
  if (void 0 !== u4.constructor) return null;
  128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f4 = u4.__e = t4.__e]), (a4 = l.__b) && a4(u4);
  n: if ("function" == typeof T4) try {
    if (k3 = u4.props, x4 = T4.prototype && T4.prototype.render, M = (a4 = T4.contextType) && i4[a4.__c], $2 = a4 ? M ? M.props.value : a4.__ : i4, t4.__c ? _4 = (h5 = u4.__c = t4.__c).__ = h5.__E : (x4 ? u4.__c = h5 = new T4(k3, $2) : (u4.__c = h5 = new C(k3, $2), h5.constructor = T4, h5.render = Q), M && M.sub(h5), h5.state || (h5.state = {}), h5.__n = i4, p5 = h5.__d = true, h5.__h = [], h5._sb = []), x4 && null == h5.__s && (h5.__s = h5.state), x4 && null != T4.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = m({}, h5.__s)), m(h5.__s, T4.getDerivedStateFromProps(k3, h5.__s))), v4 = h5.props, y5 = h5.state, h5.__v = u4, p5) x4 && null == T4.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), x4 && null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
    else {
      if (x4 && null == T4.getDerivedStateFromProps && k3 !== v4 && null != h5.componentWillReceiveProps && h5.componentWillReceiveProps(k3, $2), u4.__v == t4.__v || !h5.__e && null != h5.shouldComponentUpdate && false === h5.shouldComponentUpdate(k3, h5.__s, $2)) {
    ...
    if (h5.context = $2, h5.props = k3, h5.__P = n3, h5.__e = false, I2 = l.__r, P2 = 0, x4) h5.state = h5.__s, h5.__d = false, I2 && I2(u4), a4 = h5.render(h5.props, h5.state, h5.context), w.push.apply(h5.__h, h5._sb), h5._sb = [];
    else do {
      h5.__d = false, I2 && I2(u4), a4 = h5.render(h5.props, h5.state, h5.context), h5.state = h5.__s;
    } while (h5.__d && ++P2 < 25);
    h5.state = h5.__s, null != h5.getChildContext && (i4 = m(m({}, i4), h5.getChildContext())), x4 && !p5 && null != h5.getSnapshotBeforeUpdate && (d5 = h5.getSnapshotBeforeUpdate(v4, y5)), A3 = null != a4 && a4.type === S && null == a4.key ? E(a4.props.children) : a4, f4 = L(n3, g(A3) ? A3 : [A3], u4, t4, i4, r4, o4, e4, f4, c4, s4), h5.base = u4.__e, u4.__u &= -161, h5.__h.length && e4.push(h5), _4 && (h5.__E = h5.__ = null);
  } catch (n4) {
...
function G(u4, t4, i4, r4, o4, e4, f4, c4, s4) {
  ...
  if (null == u4) {
    ...
    u4 = document.createElementNS(o4, x4, k3.is && k3), c4 && (l.__m && l.__m(t4, e4), c4 = false), e4 = null;
  }
  if (null == x4) m4 === k3 || c4 && u4.data == k3 || (u4.data = k3);
  else {
    if (e4 = e4 && n.call(u4.childNodes), !c4 && null != e4) for (m4 = {}, a4 = 0; a4 < u4.attributes.length; a4++) m4[(y5 = u4.attributes[a4]).name] = y5.value;
    for (a4 in m4) y5 = m4[a4], "dangerouslySetInnerHTML" == a4 ? p5 = y5 : "children" == a4 || a4 in k3 || "value" == a4 && "defaultValue" in k3 || "checked" == a4 && "defaultChecked" in k3 || N(u4, a4, null, y5, o4);
    for (a4 in k3) y5 = k3[a4], "children" == a4 ? v4 = y5 : "dangerouslySetInnerHTML" == a4 ? h5 = y5 : "value" == a4 ? w5 = y5 : "checked" == a4 ? _4 = y5 : c4 && "function" != typeof y5 || m4[a4] === y5 || N(u4, a4, y5, m4[a4], o4);
...
function R(u4, t4, i4) {
  var r4, o4, e4, f4;
  t4 == document && (t4 = document.documentElement), l.__ && l.__(u4, t4), o4 = (r4 = "function" == typeof i4) ? null : i4 && i4.__k || t4.__k, e4 = [], f4 = [], q(t4, u4 = (!r4 && i4 || t4).__k = k(S, null, [u4]), o4 || d, d, t4.namespaceURI, !r4 && i4 ? [i4] : o4 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e4, !r4 && i4 ? i4 : o4 ? o4.__e : t4.firstChild, r4, f4), D(e4, u4, f4);
}
...
function w4(i4, n3, r4, t4) {
  var o4 = n3 in i4 && void 0 === i4.ownerSVGElement, e4 = y3(r4), f4 = r4.peek();
...
var activeAddress = y3((localstorage == null ? void 0 : localstorage.getItem(LocalStorageKeys.activeAddress)) || void 0);
var selectedModuleId = y3((localstorage == null ? void 0 : localstorage.getItem(LocalStorageKeys.selectedModuleId)) || void 0);
var allowedWallets = y3([]);
var activeModules = y3([]);
var activeModule = g2(() => {
  return activeModules.value.find((m4) => m4.productId === selectedModuleId.value);
});
var hardwareWalletPathsInitial = localstorage == null ? void 0 : localstorage.getItem(LocalStorageKeys.hardwareWalletPaths);
...
var wcSessionPathsInitial = localstorage == null ? void 0 : localstorage.getItem(LocalStorageKeys.wcSessionPaths);
...
function createSubject() {
  ...
  return {
    ...
    subscribe(next, error, complete) {
      if (status === "error") {
        error == null ? void 0 : error(storedError);
        return () => {
        };
      }
      if (status === "completed") {
...
function parseError(e4) {
  var _a, _b, _c;
  return {
    code: ((_a = e4 == null ? void 0 : e4.error) == null ? void 0 : _a.code) || (e4 == null ? void 0 : e4.code) || -1,
    message: ((_b = e4 == null ? void 0 : e4.error) == null ? void 0 : _b.message) || (e4 == null ? void 0 : e4.message) || typeof e4 === "string" && e4 || "Unhandled error from the wallet",
    ext: ((_c = e4 == null ? void 0 : e4.error) == null ? void 0 : _c.ext) || (e4 == null ? void 0 : e4.ext)
  };
}
function disconnect() {
  var _a;
  if ((_a = activeModule.value) == null ? void 0 : _a.disconnect) {
...
//# sourceMappingURL=chunk-P2OAZVTF.js.map
